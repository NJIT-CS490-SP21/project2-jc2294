...
!(function (a, b) {
  ...
  const s = (function (a) {
    ...
    const L = 'checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped';
    const M = '[\\x20\\t\\r\\n\\f]';
    const N = '(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+';
    ...
    (m = fb.setDocument = function (a) {
      ...
      return e !== n && e.nodeType === 9 && e.documentElement
        ...
        (c.attributes = ib((a) => ((a.className = 'i'), !a.getAttribute('className')))),
        (c.getElementsByTagName = ib((a) => (a.appendChild(e.createComment('')), !a.getElementsByTagName('*').length))),
        ...
        c.getById
          ...
          (d.filter.ID = function (a) {
            const b = a.replace(cb, db);
            return function (a) {
              const c = typeof a.getAttributeNode !== C && a.getAttributeNode('id');
              return c && c.value === b;
            };
          })),
    ...
    return (
      ...
      m(),
      (c.sortDetached = ib((a) => 1 & a.compareDocumentPosition(n.createElement('div')))),
      ib((a) => ((a.innerHTML = "<a href='#'></a>"), a.firstChild.getAttribute('href') === '#'))
        || jb('type|href|height|width', (a, b, c) => (c ? void 0 : a.getAttribute(b, b.toLowerCase() === 'type' ? 1 : 2))),
      (c.attributes
        && ib((a) => (
          (a.innerHTML = '<input/>'),
        ...
        || jb('value', (a, b, c) => (c || a.nodeName.toLowerCase() !== 'input' ? void 0 : a.defaultValue)),
        ...
        function (a) {
          ...
          if (
            ...
            try {
              for (; d > c; c++) {
                (b = this[c] || {}),
                b.nodeType === 1 && (m.cleanData(ub(b, !1)), (b.innerHTML = a));
              }
              b = 0;
            } catch (e) {}
          }
    ...
    m.cssHooks[b] = {
      ...
      set(a, c, d) {
        ...
        return Wb(
          a,
          c,
          d ? Xb(a, b, d, k.boxSizing && m.css(a, 'boxSizing', !1, e) === 'border-box', e) : 0,
        );
      },
    };
  }),
  ...
  (m.cssHooks.marginRight = Lb(k.reliableMarginRight, (a, b) => (b ? m.swap(a, { display: 'inline-block' }, Jb, [a, 'marginRight']) : void 0))),
  ...
  (m.parseJSON = function (b) {
    ...
    return e
      && !m.trim(
        e.replace(xc, (a, b, e, f) => (c && b && (d = 0), d === 0 ? a : ((c = e || b), (d += !f - !e), ''))),
      )
      ? Function(`return ${e}`)()
            ...
            send(c, d) {
              ...
              (b = function (c, e) {
                ...
                if (b && (e || f.readyState === 4)) {
                  if ((delete Xc[g], (b = void 0), (f.onreadystatechange = m.noop), e)) f.readyState !== 4 && f.abort();
                  else {
                    (j = {}),
                    (h = f.status),
  ...
  m.each(['top', 'left'], (a, b) => {
    m.cssHooks[b] = Lb(k.pixelPosition, (a, c) => (c ? ((c = Jb(a, b)), Hb.test(c) ? `${m(a).position()[b]}px` : c) : void 0));
  }),
